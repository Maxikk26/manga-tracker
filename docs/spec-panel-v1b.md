...
| **Costo por fase** | Fases 1-2: cero requests a la fuente. Fase 3: 1 request por alta. Fase 4: **medido**, ~180 requests una sola vez para las portadas (35 del tab "Leyendo" + 145 del resto) y decenas de MB en disco, más un one-off local (`my_score`) | §Fases, §Portadas |
