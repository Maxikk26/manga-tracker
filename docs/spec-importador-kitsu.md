...
Versión 1.6 — 2026-08-04. Documento 6 del paquete SDD. Depende de `spec-modelo-de-datos.md` (v1.9), de la operación `fetch_chapters` de `spec-cliente-fuente-descubrimiento.md` (v1.8), de `spec-seed-manual.md` (v2.4) y de `manganato-fuente-actual.md` (v1.4).
