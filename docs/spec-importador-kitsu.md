...
Versión 1.7 — 2026-08-30. Documento 6 del paquete SDD. Depende de `spec-modelo-de-datos.md` (v1.10), de la operación `fetch_chapters` de `spec-cliente-fuente-descubrimiento.md` (v1.11), de `spec-seed-manual.md` (v2.4) y de `manganato-fuente-actual.md` (v1.4). Pines revisados contra sus versiones vigentes al cerrar esta revisión — los cuatro siguen exactos, ninguno quedó atrasado.
