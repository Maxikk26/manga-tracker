...
Versión 1.7 — 2026-07-28. Documento 2 del paquete SDD. Depende de `one-pager-v1a.md` (v1.10). Define el esquema completo de la base de datos que se crea desde el primer día de V1a, aunque varias piezas (import Kitsu, cadencia, estadísticas) lo llenen después o lo consuman recién en V1b.
