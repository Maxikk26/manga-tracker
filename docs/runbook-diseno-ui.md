...
Versión 1.0 — 2026-08-21. Depende de `spec-panel-v1b.md` (v1.5).
...
- **Rediseñar V1b**: el rediseño es trabajo de V2. V1b se cierra con `my_score` y su migración 3.
...
- Falta correr la primera comparación completa con las tres herramientas. La del heatmap no cuenta.
- El tono/tamaño de la pastilla "+N" sigue reservado al dueño, detrás de las custom properties de `.behind-pill`. Es la pieza más chica disponible y por eso es buena candidata a primera comparación real.
