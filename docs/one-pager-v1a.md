...
2. Spec del cliente de la fuente + descubrimiento (las 3 operaciones, parseo del feed, lógica de intersección y de las tres velocidades). ✅ cerrada, hoy en v1.9.
3. Spec del bot Telegram (formato exacto de digest y heartbeat, manejo del token). ✅ cerrada, hoy en v1.7. **Ya no bloquea el corazón.**
