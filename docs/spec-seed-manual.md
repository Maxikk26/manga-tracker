...
Versión 2.4 — 2026-08-04. Documento 5 del paquete SDD. Depende de `spec-modelo-de-datos.md` (v1.10) y de la operación `fetch_chapters` de `spec-cliente-fuente-descubrimiento.md` (v1.10).
