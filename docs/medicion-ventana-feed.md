...
Versión 1.1 — 2026-07-28. Documento de apoyo del paquete SDD. Depende de `manganato-fuente-actual.md` (v1.3). Su resultado alimenta `spec-cliente-fuente-descubrimiento.md` (v1.6).
