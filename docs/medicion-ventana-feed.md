...
Versión 1.2 — 2026-08-08. Documento de apoyo del paquete SDD. Depende de `manganato-fuente-actual.md` (v1.4). Su resultado alimenta `spec-cliente-fuente-descubrimiento.md` (v1.11).
