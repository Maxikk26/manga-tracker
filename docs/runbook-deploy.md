...
Versión 1.6 — 2026-08-17. Documento operativo. Depende de `one-pager-v1a.md` (v1.14), `spec-seed-manual.md` (v2.4), `spec-cliente-fuente-descubrimiento.md` (v1.8) y `spec-panel-v1b.md` (v1.2).
